...
from psm.Backwords.nwords_simulator import NWordsMonteCarlo
import pickle
...
def wrapper():
    ...
    file = open("/disk/xm/InferenceAttack/result/pickle/rockyou_ckl.pickle","wb")
    pickle.dump(backword_mc,file)
    file.close()
