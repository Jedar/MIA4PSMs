...
void output(ofstream &fileout, char *pwd, vector<double>& vec){
...
int main(int argc, char *argv[])
{
	...
	while (true)
	{
		...
		output(fileout, password, scores);
	}
	/*
