...
def main():
    ...
    cli.add_argument("--no-output", required=False, action="store_true", default=False, dest="no_output",
                    help="not need output")
    ...
    if args.detail:
        f.finish()
    print(f"containing date: {total_cnt / total_pwd * 100:7.4f} %", file=sys.stderr)
    pass
